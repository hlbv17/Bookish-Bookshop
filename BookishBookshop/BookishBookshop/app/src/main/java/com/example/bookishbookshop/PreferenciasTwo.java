...
public class PreferenciasTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * ---Asignar Variables-------------------------------------------------------------------*/
        logo = findViewById(R.id.iv_Logo_Preferences2);
        scrvP2 = findViewById(R.id.scrollView_Preferences2);
        ...
        ViewGroup.LayoutParams scrvP1P = (ViewGroup.MarginLayoutParams) scrvP2.getLayoutParams();
        ...
        ViewGroup.LayoutParams btnListoP = (ViewGroup.MarginLayoutParams) botonSiguiente.getLayoutParams();
        btnListoP.width = calWidth(buttonsX);
        btnListoP.height = calHeight(buttonsY);
